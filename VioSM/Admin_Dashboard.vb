Public Class Admin_Dashboard
    ...
    Private Sub btnSellers_Click(sender As Object, e As EventArgs) Handles btnSellers.Click
        ...
        Me.Hide() ' Hide the current Category_Form
    End Sub
    ' Navigate to Selling Form when btnSelling is clicked
    ' In your current form (e.g., Form1.vb), add the following code for the button click event.




    Private Sub btnSelling_Click(sender As Object, e As EventArgs)
